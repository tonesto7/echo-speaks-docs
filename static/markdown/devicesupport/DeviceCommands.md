...
<pre style="background-color: #ebecec;margin: 0 1em;"><b><i>Description:</i></b> 
<small>Replays the last text sent</small></pre>
  
<pre style="background-color: #ebecec; margin: 20px 1em;"><b><i>Parameters</i></b></div><div style="padding: 0.5em;">
None Accepted</div></pre>
